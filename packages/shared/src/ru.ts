export const RU = {
  web: {
    create: {
      ...
      tasksEmpty: "Нет активных заданий. Добавьте задания в админке.",
      categories: {
        movies: "Кино/сериалы",
        memes: "Мемы",
        politics: "Политика",
    ...
    result: {
      ...
      replayConfirmNo: "\u041d\u0435\u0442",
      replayConfirmYes: "\u0414\u0430, \u043f\u043e\u0435\u0445\u0430\u043b\u0438!",
      replayConfirmLoading: "...",
      replayConfirmSent:
        "\u041f\u043e\u0434\u0442\u0432\u0435\u0440\u0436\u0434\u0435\u043d\u0438\u0435 \u043e\u0442\u043f\u0440\u0430\u0432\u043b\u0435\u043d\u043e. \u041e\u0436\u0438\u0434\u0430\u0435\u043c \u0437\u0430\u043f\u0443\u0441\u043a...",
    ...
    admin: {
      ...
      tasks: {
        title: "Задания",
        totalLabel: (total: number) => `Всего заданий: ${total}`,
        ...
        filterArchived: "Отключенные",
        emptyTitle: "Заданий не найдено",
        emptyButton: "➕ Добавить первое задание",
        textLabel: "Текст задания",
        textPlaceholder: "Например: Озвучь максимально драматично",
        ...
        statusArchived: "Отключено",
        loading: "Загрузка...",
        loadError: "Ошибка загрузки",
        createError: "Ошибка создания",
        updateError: "Ошибка обновления",
        validationTooShort: "Текст слишком короткий",
        validationTooLong: "Текст слишком длинный",
        duplicateError: "Такое задание уже есть",
      },
      upload: {
        title: "Загрузка новой сцены",
        subtitle: "Создайте новую сцену для озвучки",
        selectVideo: "Загрузите видео",
        dropHint: "Перетащите файл сюда или нажмите для выбора",
        selected: (name: string, sizeMb: string) => `Выбрано: ${name} (${sizeMb} MB)`,
        nameLabel: "Название сцены",
        namePlaceholder: "Например: Классика мемов",
        categoryLabel: "Категория",
        back: "← Назад",
        next: "Далее →",
        uploadButton: "✅ Загрузить сцену",
        uploading: "Загрузка...",
        errorSelectVideo: "Выберите видео файл",
        errorTooLarge: (sizeMb: string, maxMb: string) =>
          `Файл слишком большой (${sizeMb} MB). Максимум: ${maxMb} MB`,
        errorLoadVideo: "Не удалось загрузить видео",
        errorNeedVideo: "Загрузите видео",
        errorNeedTitle: "Введите название",
        errorNeedFields:
          "Заполните все поля и добавьте хотя бы один тайминг",
      ...
      edit: {
        ...
        categoryLabel: "Категория",
        videoLabel: "Видео",
        newVideo: (name: string, sizeMb: string) =>
          `Новое видео: ${name} (${sizeMb} MB)`,
        cancelReplace: "Отменить замену",
        currentVideo: (name: string) => `Текущее видео: ${name}`,
        ...
        errorSelectVideo: "Выберите видео файл",
        errorNeedFields: "Заполните все поля",
        errorNeedCues: "Добавьте хотя бы один тайминг",
  ...
  bot: {
    ...
    start: {
      welcome:
        "\u{1F3A4} \u0417\u043B\u043E\u0431\u043D\u0430\u044F \u043E\u0437\u0432\u0443\u0447\u043A\u0430 - \u044D\u0442\u043E \u0438\u0433\u0440\u0430, \u0432 \u043A\u043E\u0442\u043E\u0440\u043E\u0439 \u0432\u044B \u043E\u0437\u0432\u0443\u0447\u0438\u0432\u0430\u0435\u0442\u0435 \u044D\u043F\u0438\u0437\u043E\u0434\u044B \u0438\u0437 \u043A\u0438\u043D\u043E, \u0441\u0435\u0440\u0438\u0430\u043B\u043E\u0432, \u043C\u0435\u043C\u043E\u0432 \u0438 \u043F\u0440\u043E\u0447\u0438\u0445 \u0440\u043E\u043B\u0438\u043A\u043E\u0432.\n\n" +
        "\u{1F3AE} \u0412\u044B\u0431\u0435\u0440\u0438\u0442\u0435 \u043A\u043E\u043B\u0438\u0447\u0435\u0441\u0442\u0432\u043E \u0438\u0433\u0440\u043E\u043A\u043E\u0432 - \u043C\u043E\u0436\u043D\u043E \u0438\u0433\u0440\u0430\u0442\u044C \u043E\u0434\u043D\u043E\u043C\u0443 \u0438 \u043E\u0437\u0432\u0443\u0447\u0438\u0442\u044C \u0432\u0441\u0435 \u0440\u0435\u043F\u043B\u0438\u043A\u0438 \u0441\u0430\u043C\u043E\u0441\u0442\u043E\u044F\u0442\u0435\u043B\u044C\u043D\u043E \u0438\u043B\u0438 \u0436\u0435 \u043F\u0440\u0438\u0433\u043B\u0430\u0441\u0438\u0442\u044C \u0434\u0440\u0443\u0433\u0430 \u0438 \u0441\u044B\u0433\u0440\u0430\u0442\u044C \u0432\u0434\u0432\u043E\u0435\u043C.\n\n" +
        "\u{1F3AC} \u0412\u044B\u0431\u0435\u0440\u0438\u0442\u0435 \u043A\u0430\u0442\u0435\u0433\u043E\u0440\u0438\u044E \"\u041A\u0438\u043D\u043E \u0438 \u0441\u0435\u0440\u0438\u0430\u043B\u044B\", \"\u041C\u0435\u043C\u044B\" \u0438\u043B\u0438 \"\u041F\u043E\u043B\u0438\u0442\u0438\u043A\u0430\" - \u0432\u0430\u043C \u0441\u043B\u0443\u0447\u0430\u0439\u043D\u044B\u043C \u043E\u0431\u0440\u0430\u0437\u043E\u043C \u043F\u043E\u043F\u0430\u0434\u0435\u0442\u0441\u044F \u044D\u043F\u0438\u0437\u043E\u0434 \u0438\u0437 \u0432\u044B\u0431\u0440\u0430\u043D\u043D\u043E\u0433\u043E \u043D\u0430\u0431\u043E\u0440\u0430. \u0415\u0441\u043B\u0438 \u0432\u0430\u043C \u043D\u0435 \u043F\u043E\u043D\u0440\u0430\u0432\u0438\u043B\u0441\u044F \u044D\u043F\u0438\u0437\u043E\u0434 - \u043D\u0430\u0436\u043C\u0438\u0442\u0435 \u043A\u043D\u043E\u043F\u043A\u0443 \u043F\u0440\u043E\u043F\u0443\u0441\u0442\u0438\u0442\u044C.\n\u041D\u0430 \u0434\u0430\u043D\u043D\u044B\u0439 \u043C\u043E\u043C\u0435\u043D\u0442 \u043B\u0443\u0447\u0448\u0435 \u0438\u0433\u0440\u0430\u0442\u044C \u0438\u043C\u0435\u043D\u043D\u043E \u0432 \u043A\u0430\u0442\u0435\u0433\u043E\u0440\u0438\u044E \u201C\u041A\u0438\u043D\u043E \u0438 \u0441\u0435\u0440\u0438\u0430\u043B\u044B\u201D - \u0432 \u043D\u0435\u0439 \u0434\u043E\u0431\u0430\u0432\u043B\u0435\u043D\u043E 60 \u0441\u0446\u0435\u043D.\n\n" +
        "\u{2757}\u{FE0F} \u0414\u0430\u043B\u0435\u0435 \u0440\u0435\u0436\u0438\u043C - \u043C\u043E\u0436\u043D\u043E \u043E\u0437\u0432\u0443\u0447\u0438\u0432\u0430\u0442\u044C \u0441\u0432\u043E\u0431\u043E\u0434\u043D\u043E \u0438\u043B\u0438 \u0436\u0435 \u043E\u0437\u0432\u0443\u0447\u0438\u0432\u0430\u0442\u044C \u043F\u043E \u0441\u043B\u0443\u0447\u0430\u0439\u043D\u043E \u0432\u044B\u043F\u0430\u0432\u0448\u0435\u043C\u0443 \u0437\u0430\u0434\u0430\u043D\u0438\u044E.\n\n" +
        "\u{25B6}\u{FE0F} \u041F\u0440\u043E\u0441\u043C\u043E\u0442\u0440\u0438\u0442\u0435 \u044D\u043F\u0438\u0437\u043E\u0434, \u043F\u0440\u0438\u0434\u0443\u043C\u0430\u0439\u0442\u0435 \u0441\u0432\u043E\u044E \u0432\u0435\u0440\u0441\u0438\u044E \u043E\u0437\u0432\u0443\u0447\u043A\u0438 \u0438 \u0437\u0430\u043F\u0438\u0448\u0438\u0442\u0435 \u0435\u0435. \u041E\u0431\u0440\u0430\u0449\u0430\u0439\u0442\u0435 \u0432\u043D\u0438\u043C\u0430\u043D\u0438\u0435 \u043D\u0430 \u0434\u043B\u0438\u0442\u0435\u043B\u044C\u043D\u043E\u0441\u0442\u044C \u0432\u0430\u0448\u0435\u0439 \u0440\u043E\u043B\u0438 \u0438 \u043F\u043E\u0434\u0433\u043E\u043D\u044F\u0439\u0442\u0435 \u0441\u0432\u043E\u0438 \u0440\u0435\u043F\u043B\u0438\u043A\u0438, \u0447\u0442\u043E\u0431\u044B \u0432\u043F\u0438\u0441\u0430\u0442\u044C\u0441\u044F \u0432 \u0442\u0430\u0439\u043C\u0438\u043D\u0433\u0438!\n\n" +
        "\u{2705} \u041D\u0430\u0441\u043B\u0430\u0436\u0434\u0430\u0439\u0442\u0435\u0441\u044C \u0440\u0435\u0437\u0443\u043B\u044C\u0442\u0430\u0442\u043E\u043C, \u0434\u0430 \u043F\u0440\u0435\u0431\u0443\u0434\u0435\u0442 \u0441 \u0432\u0430\u043C\u0438 \u043A\u0440\u0435\u0430\u0442\u0438\u0432 \u0438 \u0438\u0441\u043A\u0440\u043E\u043C\u0435\u0442\u043D\u044B\u0439 \u044E\u043C\u043E\u0440!\n\n" +
        "\u{2764}\u{FE0F} \u041A\u0430\u0436\u0434\u044B\u0439 \u0438\u0433\u0440\u043E\u043A \u043C\u043E\u0436\u0435\u0442 \u0434\u043E\u0431\u0430\u0432\u0438\u0442\u044C \u0441\u0432\u043E\u0439 \u044D\u043F\u0438\u0437\u043E\u0434 \u0432 \u0438\u0433\u0440\u0443! \u041D\u0430\u0436\u043C\u0438\u0442\u0435 \u0432 \u0431\u043E\u0442\u0435 \u043A\u043D\u043E\u043F\u043A\u0443 \"\u041F\u0440\u0435\u0434\u043B\u043E\u0436\u0438\u0442\u044C \u044D\u043F\u0438\u0437\u043E\u0434\" \u0438 \u0441\u043B\u0435\u0434\u0443\u0439\u0442\u0435 \u0438\u043D\u0441\u0442\u0440\u0443\u043A\u0446\u0438\u0438.",
      openGameLink:
